...
let customer_tagSchema = require('../schemas/customer_tag-schema.json');



class Customer_tagModel extends CoreModel {
    ...
    static async save(params) {
        ...
        try {
            let query = `INSERT INTO customer_tags (${params.insertSql.INSERT}) VALUES(${params.insertSql.VALUES})`;
    ...
    static async prepareUpdate(params) {
        ...
        for (let colname in columns) {
            if ( !customer_tagSchema.updateColums.includes(colname) )
            continue;
    ...
    static async prepareSave(params) {
        ...
        for (let colname in columns) {
            if ( !customer_tagSchema.createColums.includes(colname) )
            continue;
    ...
    static async getModelName() {
        return "Customer_tags Model"
    }


}

module.exports = Customer_tagModel